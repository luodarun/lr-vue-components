<template>
  <li
    ...
    class="lr-select-dropdown__item"
    v-show="visible"
    :class="{
...
import { getValueByPath, escapeRegexpString } from "lr-ui/src/utils/util";
  ...
  watch: {
    currentLabel() {
      if (!this.created && !this.select.remote)
        this.dispatch("LrSelect", "setSelected");
    },
    value(val, oldVal) {
  ...
  methods: {
    ...
    selectOptionClick() {
      if (this.disabled !== true && this.groupDisabled !== true) {
        this.dispatch("LrSelect", "handleOptionClick", [this, true]);
      }
    },
