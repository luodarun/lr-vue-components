<script>
import LrCollapseTransition from "lr-ui/src/transitions/collapse-transition";
...
export default {
  ...
  componentName: "LrSubmenu",

  mixins: [menuMixin, Emitter, poperMixins],

  components: { LrCollapseTransition },
  ...
  computed: {
    ...
    menuTransitionName() {
      return this.rootMenu.collapse ? "lr-zoom-in-left" : "lr-zoom-in-top";
    },
    opened() {
    ...
    isFirstLevel() {
      ...
      while (parent && parent !== this.rootMenu) {
        if (
          ["LrSubmenu", "LrMenuItemGroup"].indexOf(
  ...
  methods: {
    ...
    handleClick() {
      ...
      this.dispatch("LrMenu", "submenu-click", this);
    },
    handleMouseenter(event, showTimeout = this.showTimeout) {
      ...
      this.dispatch("LrSubmenu", "mouse-enter-child");
    ...
    handleMouseleave(deepDispatch = false) {
      ...
      this.dispatch("LrSubmenu", "mouse-leave-child");
      clearTimeout(this.timeout);
      this.timeout = setTimeout(() => {
      ...
      if (this.appendToBody && deepDispatch) {
        if (this.$parent.$options.name === "LrSubmenu") {
  ...
  render(h) {
    ...
    const popupMenu = (
      <transition name={menuTransitionName}>
        <div
          ref="menu"
          v-show={opened}
          class={[`lr-menu--${mode}`, popperClass]}
        ...
        >
          <ul
            role="menu"
            class={[
              "lr-menu lr-menu--popup",
              `lr-menu--popup-${currentPlacement}`
            ]}
    ...
    return (
      ...
      >
        ...
        >
          {$slots.title}
          <i class={["lr-submenu__icon-arrow", submenuTitleIcon]}></i>
        </div>
