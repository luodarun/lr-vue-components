...
export default {
  ...
  methods: {
    ...
    getColumnLrIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn(
          "[Lrement Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header."
        );
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnLrIndex(children, this.$el);
