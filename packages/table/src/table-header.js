import Vue from "vue";
import { hasClass, addClass, removeClass } from "lr-ui/src/utils/dom";
...
export default {
              ...
              {columns.map((column, cellIndex) => (
                ...
                >
                  ...
                  >
                    ...
                    {column.filterable ? (
                      <span
                        class="lr-table__column-filter-trigger"
                        on-click={$event =>
                      ...
                      >
                        <i
                          class={[
                            "lr-icon-arrow-down",
                            column.filterOpened ? "lr-icon-arrow-up" : ""
                          ]}
                        ></i>
                      </span>
                    ) : (
  ...
  mounted() {
    // nextTick 是有必要的 https://github.com/LremeFE/element/pull/11311
    this.$nextTick(() => {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector(".lr-table__column-filter-trigger") || cell;
